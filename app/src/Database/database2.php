...
$sql =
    "ALTER TABLE customers CHANGE shippingAddress shippingAddress varchar(255) DEFAULT NULL";
mysqli_query($conn, $sql);

$sql =
    "ALTER TABLE customers CHANGE shippingCity shippingCity varchar(100) DEFAULT NULL";
mysqli_query($conn, $sql);

$sql =
    "ALTER TABLE customers CHANGE shippingProvince shippingProvince varchar(100) DEFAULT NULL";
mysqli_query($conn, $sql);

$sql =
    "ALTER TABLE customers CHANGE shippingCountry shippingCountry varchar(100) DEFAULT NULL";
mysqli_query($conn, $sql);

$sql =
    "ALTER TABLE customers CHANGE shippingPostal shippingPostal varchar(20) DEFAULT NULL";
mysqli_query($conn, $sql);
